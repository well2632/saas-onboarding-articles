...
import { Category, Article } from '@/app/page';

// Este componente de cliente recebe as categorias do seu componente de servidor pai.
export default function AdminView({ categories, articles }: { categories: Category[]; articles: Article[] }) {
  ...
  return (
    <div className="p-4 md:p-8 min-h-screen bg-gray-50">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        {activeTab === 'articles' && <ArticleManager categories={categories} articles={articles} />}
      </div>
    </div>
  );
}
